<template>
  <div>
    <!-- Floating jukebox toggle - only when player is hidden -->
    <div v-if="!track" class="position-fixed bottom-0 end-0 p-3 d-block" style="z-index: 1000">
      <b-button
        title="Jukebox Mode"
        variant="light"
    ...
    <div :class="{ visible: track }" class="player d-flex">
      <div class="flex-fill">
        ...
        <div class="row align-items-center m-0 elevated">
          <!-- Track info --->
          <div
            class="col p-0 d-flex flex-nowrap align-items-center justify-content-start"
            ...
            <div class="d-flex flex-nowrap justify-content-end pe-3">
              ...
              <OverflowMenu class="d-md-none" variant="transparent" direction="up">
                ...
                >
                  ...
                  >
                    <small
                      v-if="replayGainMode === ReplayGainMode.None"
